...
const MarketingBlog = () => {
  return (
    <section className="relative mb-14 mt-14 w-full bg-[#E8EDEF] pt-14 md:mb-[272px] md:mt-16 md:pt-16 lg:mb-[260px] lg:mt-[88px] lg:pt-[88px] xl:mb-[250px] xl:mt-[100px] xl:pt-[100px]">
          ...
          <div className="w-full md:max-w-[370px] md:self-end lg:max-w-[470px]">
            ...
            <RevealWrapper as="ul" className="reveal-me mt-5 justify-self-end max-md:w-full md:mt-10">
              <li className="mx-auto block w-full text-center md:inline-block md:w-auto">
                <Link href="/ai-blog" className="rv-button rv-button-white block !bg-[#E8EDEF] md:inline-block">
                  <div className="rv-button-top !bg-[#E8EDEF] dark:!border-secondary/30">
