...
const HeroV11 = () => {
  ...
  useEffect(() => {
    const imagePaths: string[] = [
      '/images/home-4/random-1.webp',
      '/images/home-4/random-2.webp',
      '/images/home-4/random-3.webp',
      '/images/home-4/random-4.webp',
      '/images/home-4/random-5.webp',
      '/images/home-4/random-6.webp',
    ]
  ...
  return (
    <RevealWrapper
      ...
      <figure className="absolute left-[8%] top-[12%] hidden md:block lg:left-[24%] lg:top-[15%]">
        <img src="/images/home-4/random-1.webp" alt="" className="decorative-image" ref={setImageRef(0)} />
      </figure>
      <figure className="absolute right-[15%] top-[7%] hidden md:block lg:right-[29%] lg:top-[11%]">
        <img src="/images/home-4/random-2.webp" alt="" className="decorative-image" ref={setImageRef(1)} />
      </figure>
      <figure className="absolute left-[2%] top-[42%] hidden lg:block">
        <img src="/images/home-4/random-3.webp" alt="" className="decorative-image" ref={setImageRef(2)} />
      </figure>
      <figure className="absolute right-[2%] top-[32%] hidden lg:block">
        <img src="/images/home-4/random-4.webp" alt="" className="decorative-image" ref={setImageRef(3)} />
      </figure>
      <figure className="absolute bottom-[4%] left-[12%] hidden md:block lg:bottom-[7%] lg:left-[23%]">
        <img src="/images/home-4/random-5.webp" alt="" className="decorative-image" ref={setImageRef(4)} />
      </figure>
      <figure className="absolute bottom-[1%] right-[3%] hidden md:block lg:bottom-[3%] lg:right-[5%]">
        <img src="/images/home-4/random-6.webp" alt="" className="decorative-image" ref={setImageRef(5)} />
      </figure>
    </RevealWrapper>
  )
}
