...
const cardData = [
  { number: 30, label: 'Yıl: Sektörel Deneyim', prefix: '+' },
  { number: 1000, label: 'Konut: Mutlu Ev Sahibi', prefix: '+' },
  { number: 3, label: 'Sektör: Turizm, İnşaat ve Tarımda Öncü', prefix: '' },
]
        ...
        <div className="text-center">
          <TextAppearAnimation>
            <h2 className="text-appear mx-auto mb-8 md:mb-16">
              Geleceğin yaşam alanlarını, <br /> geçmişin köklü tecrübesiyle inşa ediyoruz
            </h2>
          </TextAppearAnimation>
        </div>
