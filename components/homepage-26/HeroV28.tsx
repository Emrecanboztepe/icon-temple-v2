...
interface HeroV28Props {
  description?: string
}

const HeroV28: FC<HeroV28Props> = ({ description }) => {
      ...
      <RevealWrapper className="mx-auto max-w-screen-xl px-5">
        <div>
          <h3 className="text-center lg:text-left">
            Ege'nin Kalbinde,<br className="lg:hidden" />  Hayatınıza Yakışan İhtişam
          </h3>
          <h1 className="text-center font-normal lg:text-left xl:text-[96px] xl:leading-[1.3] xl:tracking-[-2.88px]">
            ...
            <CtaImageSlider
              slides={[
                { id: '1', img: '/images/agent/ferah.webp' },
                { id: '2', img: '/images/agent/aile.webp' },
                { id: '3', img: '/images/agent/prestij.webp' },
                { id: '4', img: '/images/agent/konfor.webp' },
