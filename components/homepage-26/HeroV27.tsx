...
interface HeroV27Props {
  description?: string
}

const HeroV27: FC<HeroV27Props> = ({ description }) => {
      ...
      <RevealWrapper className="mx-auto max-w-screen-xl px-5">
        <div>
          <h3 className="text-center lg:text-left">
            Sevdiklerinizle Paylaşacağınız<br className="lg:hidden" />  Dört Mevsim Konfor
          </h3>
          <h1 className="text-center font-normal lg:text-left xl:text-[96px] xl:leading-[1.3] xl:tracking-[-2.88px]">
            ...
            <CtaImageSlider
              slides={[
                { id: '1', img: '/images/agent/huzur.webp' },
                { id: '2', img: '/images/agent/birliktelik.webp' },
                { id: '3', img: '/images/agent/yasam.webp' },
                { id: '4', img: '/images/agent/mutluluk.webp' },
                { id: '5', img: '/images/agent/didim.webp' },
              ]}
            />
            Ritüelin
          </h1>
